...
$plugin->version  = 2022121301;   // The (date) version of this module + 2 extra digital for daily versions
...
$plugin->component = 'local_iic_service';
$plugin->cron     = 0;
$plugin->release = '1.0 (Build: 2022121301)';
